...
@section('content')
            ...
            <div class="intro__inner">
                <div class="inner__left">
                    <p class="inner__title">
                        Sblog is a place to write, read, and connect
                    </p>
                    ...
                    <button class="start__button">Start Writing</button>

                </div>

                <div class="inner__right">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                         data-name="Layer 1" width="500" height="400" viewBox="0 0 786.81995 572.25773">
                        ...
                        <path
                            ...
                            transform="translate(-206.59003 -163.87113)" fill="#6c63ff"/>
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-206.59003 -163.87113)" fill="#3f3d56"/>
                        <circle id="a657ec4b-47ce-4d2a-9c58-81a811696ca9" data-name="Ellipse 5" cx="386.3965"
                                cy="267.20052" r="44.55826" fill="#ffb6b6"/>
                        <path
    ...
    {{--    <section class="top_eight_blogs">--}}
    {{--        <div class="container">--}}
    {{--            <div class="top__eight__head">--}}
    {{--                Most popular blogs on Sblog--}}
    {{--            </div>--}}

    {{--            <div class="top__eight__by__two">--}}
    {{--                <div class="top__eight__main">--}}
    {{--                    <span class="top__eight__number" style="margin-right: 12px">01</span>--}}
    {{--                    <img class="top__eight__img" src="{{asset('img/first.png')}}" alt="">--}}
    {{--                    <div class="top__eight__info">--}}
    {{--                        <span class="top__eight__title">The Longest Equations in Physics And Mathematics</span>--}}
    {{--                        <div class="top__eight__author__date">--}}
    {{--                            <span class="top__eight__author__name">by Sapa Shirmadov</span>--}}
    {{--                            <span class="top__eight__blog__date">Jan 25, 2022</span>--}}
    {{--                        </div>--}}
    {{--                    </div>--}}
    {{--                </div>--}}

    {{--                <div class="top__eight__main">--}}
    {{--                    <span class="top__eight__number">02</span>--}}
    {{--                    <img class="top__eight__img" src="{{asset('img/second.jpg')}}" alt="">--}}
    {{--                    <div class="top__eight__info">--}}
    {{--                        <span class="top__eight__title">WEN SUNDAE? Thursday!</span>--}}
    {{--                        <div class="top__eight__author__date">--}}
    {{--                            <span class="top__eight__author__name">by Sapa Shirmadov</span>--}}
    {{--                            <span class="top__eight__blog__date">Jan 25, 2022</span>--}}
    {{--                        </div>--}}
    ...
    {{--            <div class="top__eight__by__two">--}}
    {{--                <div class="top__eight__main">--}}
    {{--                    <span class="top__eight__number">03</span>--}}
    {{--                    <img class="top__eight__img" src="{{asset('img/first.png')}}" alt="">--}}
    {{--                    <div class="top__eight__info">--}}
    {{--                        <span class="top__eight__title">The Longest Equations in Physics And Mathematics</span>--}}
    {{--                        <div class="top__eight__author__date">--}}
    ...
    {{--                <div class="top__eight__main">--}}
    {{--                    <span class="top__eight__number">04</span>--}}
    {{--                    <img class="top__eight__img" src="{{asset('img/second.jpg')}}" alt="">--}}
    {{--                    <div class="top__eight__info">--}}
    {{--                        <span class="top__eight__title">WEN SUNDAE? Thursday!</span>--}}
    {{--                        <div class="top__eight__author__date">--}}
    ...
    {{--            <div class="top__eight__by__two">--}}
    {{--                <div class="top__eight__main">--}}
    {{--                    <span class="top__eight__number">05</span>--}}
    {{--                    <img class="top__eight__img" src="{{asset('img/first.png')}}" alt="">--}}
    {{--                    <div class="top__eight__info">--}}
    {{--                        <span class="top__eight__title">The Longest Equations in Physics And Mathematics</span>--}}
    {{--                        <div class="top__eight__author__date">--}}
    ...
    {{--                <div class="top__eight__main">--}}
    {{--                    <span class="top__eight__number">06</span>--}}
    {{--                    <img class="top__eight__img" src="{{asset('img/second.jpg')}}" alt="">--}}
    {{--                    <div class="top__eight__info">--}}
    {{--                        <span class="top__eight__title">WEN SUNDAE? Thursday!</span>--}}
    {{--                        <div class="top__eight__author__date">--}}
    ...
    {{--            <div class="top__eight__by__two">--}}
    {{--                <div class="top__eight__main">--}}
    {{--                    <span class="top__eight__number">07</span>--}}
    {{--                    <img class="top__eight__img" src="{{asset('img/first.png')}}" alt="">--}}
    {{--                    <div class="top__eight__info">--}}
    {{--                        <span class="top__eight__title">The Longest Equations in Physics And Mathematics</span>--}}
    {{--                        <div class="top__eight__author__date">--}}
    ...
    {{--                <div class="top__eight__main">--}}
    {{--                    <span class="top__eight__number">08</span>--}}
    {{--                    <img class="top__eight__img" src="{{asset('img/second.jpg')}}" alt="">--}}
    {{--                    <div class="top__eight__info">--}}
    {{--                        <span class="top__eight__title">WEN SUNDAE? Thursday!</span>--}}
    {{--                        <div class="top__eight__author__date">--}}
    ...
    <section class="list_blogs">
        <div class="container">
            <span class="discover__title">Recommended</span>
            {{--                                @foreach($blogs as $blog)--}}
            {{--                                 <a class="list__blogs__main" href="/blog/{{$blog->slug_name}}">--}}
            {{--                                     <img class="list__blogs__img" src="{{asset('img/first.png')}}" alt="">--}}
            {{--                                     <div class="list__blogs__info">--}}
            {{--                                         <span class="list__blogs__title">{{substr($blog->name,0,70)}}</span>--}}
            {{--                                         <span class="list__blogs__short__text">{{substr($blog->text,0,50)}}...</span>--}}
            {{--                                         <div class="list__blogs__author__date">--}}
            {{--                                             <span class="list__blogs__author__name">by Sapa Shirmadov</span>--}}
            {{--                                             <span class="list__blogs__date">Jan 25, 2022</span>--}}
            {{--                                         </div>--}}
            {{--                                     </div>--}}
            {{--                                 </a>--}}
            ...
            <div class="blogs__main">
                <div class="blogs__user__info">
                    <img class="blogs__user_img" src="{{asset('img/profile/bill_gates.jpg')}}" alt="">
                    <span class="blogs__user__name">Bill Gates</span>
                    <div style="display: inline-block; float: right">
                               <span class="blogs__user__fill">
            ...
            <div class="blogs__main">
                    <div class="blogs__user__info">
                        ...
                        <div style="display: inline-block; float: right">
                               <span class="blogs__user__fill">
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23" viewBox="0 0 29 30" fill="none">--}}
{{--                        <path--}}
{{--                            d="M1 10.5912C1 6.06984 1 3.80918 2.45073 2.40459C3.90147 1 6.23639 1 10.9062 1H17.5104C22.1802 1 24.5152 1 25.9659 2.40459C27.4166 3.80918 27.4166 6.06984 27.4166 10.5912V21.5053C27.4166 25.7946 27.4166 27.9392 26.0227 28.5952C24.6287 29.2511 22.8869 27.9261 19.4034 25.2761L18.2885 24.428C16.3298 22.9379 15.3504 22.1929 14.2083 22.1929C13.0662 22.1929 12.0869 22.9379 10.1281 24.428L9.01326 25.2761C5.5297 27.9261 3.78792 29.2511 2.39396 28.5952C1 27.9392 1 25.7946 1 21.5053V10.5912Z"--}}
...
{{--</svg>--}}
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none">
        <path d="M4 9C4 6.17157 4 4.75736 4.87868 3.87868C5.75736 3 7.17157 3 10 3H14C16.8284 3 18.2426 3 19.1213 3.87868C20 4.75736 20 6.17157 20 9V15.8276C20 18.5109 20 19.8525 19.1557 20.2629C18.3114 20.6733 17.2565 19.8444 15.1465 18.1866L14.4713 17.656C13.2849 16.7239 12.6917 16.2578 12 16.2578C11.3083 16.2578 10.7151 16.7239 9.52871 17.656L8.85346 18.1866C6.74355 19.8444 5.68859 20.6733 4.84429 20.2629C4 19.8525 4 18.5109 4 15.8276V9Z" fill="#00B2FF" stroke="#00B2FF" stroke-width="1"/>
    </svg>
                ...
                <img class="blogs__img" src="{{asset('img/first.png')}}" alt="">
                <div class="blogs__info">
                    <a href="/blog/{{$blog->slug_name}}" style="text-decoration: none;color:#000000">
                        <span class="blogs__title">{{substr($blog->name,0,70)}}</span>
                        <span
                            class="blogs__short__text">{{substr($blog->text,0,50)}}...</span>
                    </a>
                    <span class="blogs__category">Economy</span>
                </div>
                <div class="blogs__footer">
